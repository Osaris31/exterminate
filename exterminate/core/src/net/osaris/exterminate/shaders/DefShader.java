...
public class DefShader extends DefaultShader {
	public static class Config extends DefaultShader.Config {
		...
		public Config () {
			...
			vertexShader = Gdx.files.classpath("net/osaris/exterminate/shaders/deffereddefault.vertex.glsl").readString();
			fragmentShader = Gdx.files.classpath("net/osaris/exterminate/shaders/deffereddefault.fragment.glsl").readString();
		}
	...
	public DefShader(Renderable renderable) {
		super(renderable);
	}
	

	public DefShader(Renderable renderable, Config config) {
