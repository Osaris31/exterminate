...
public final class PostProcessor implements Disposable {
	...
	public PostProcessor (boolean useDepth, boolean fsaa, boolean useAlphaChannel, boolean use32Bits) {
		this(Gdx.graphics.getWidth(), Gdx.graphics.getHeight(), useDepth, fsaa, useAlphaChannel, use32Bits);
	}
	...
	public PostProcessor (int fboWidth, int fboHeight, boolean useDepth, boolean fsaa, boolean useAlphaChannel, boolean use32Bits) {
		this(fboWidth, fboHeight, useDepth, fsaa, useAlphaChannel, use32Bits, TextureWrap.ClampToEdge, TextureWrap.ClampToEdge);
	}

	/** Construct a new PostProcessor with the given parameters and viewport, defaulting to <em>TextureWrap.ClampToEdge</em> as
	 * texture wrap mode */
	public PostProcessor (Rectangle viewport, boolean useDepth, boolean fsaa, boolean useAlphaChannel, boolean use32Bits) {
		this((int)viewport.width, (int)viewport.height, useDepth, fsaa, useAlphaChannel, use32Bits, TextureWrap.ClampToEdge,
			TextureWrap.ClampToEdge);
		setViewport(viewport);
	}

	/** Construct a new PostProcessor with the given parameters, viewport and the specified texture wrap mode */
	public PostProcessor (Rectangle viewport, boolean useDepth, boolean fsaa, boolean useAlphaChannel, boolean use32Bits, TextureWrap u,
		TextureWrap v) {
		this((int)viewport.width, (int)viewport.height, useDepth, fsaa, useAlphaChannel, use32Bits, u, v);
		setViewport(viewport);
	}
	 ...
	 * @param fsaa */
	public static PingPongBuffer newPingPongBuffer (int width, int height, Format frameBufferFormat, boolean hasDepth, boolean fsaa) {
		PingPongBuffer buffer = new PingPongBuffer(width, height, frameBufferFormat, hasDepth, fsaa);
		buffers.add(buffer);
		return buffer;
	}
	...
	public static void restoreViewport (FrameBuffer dest) {
