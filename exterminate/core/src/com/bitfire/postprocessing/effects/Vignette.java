...
public final class Vignette extends PostProcessorEffect {
	...
	public void setRouge(float rouge) {
		vignetting.setRouge(rouge);
	}
	
	public float getRouge() {
		return vignetting.getRouge();
	}

	public void setExposure(float rouge) {
		vignetting.setExposure(rouge);
	}
	
	public float getExposure() {
		return vignetting.getExposure();
	}

	public void setContrast(float rouge) {
		vignetting.setContrast(rouge);
	}
	
	public float getContrast() {
		return vignetting.getContrast();
	}
}
