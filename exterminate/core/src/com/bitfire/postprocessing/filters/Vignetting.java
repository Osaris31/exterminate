...
public final class Vignetting extends Filter<Vignetting> {
	...
	public enum Param implements Parameter {
		...
		Texture0("u_texture0", 0), TexLUT("u_texture1", 0), VignetteIntensity("VignetteIntensity", 0), VignetteX("VignetteX", 0), VignetteY(
			"VignetteY", 0), Saturation("Saturation", 0), Rouge("rouge", 0), Exposure("exposure", 0), Contrast("apply", 0), SaturationMul("SaturationMul", 0), LutIntensity("LutIntensity", 0), LutIndex(
	...
	public void setContrast (float value) {
		contrast = value;
		setParam(Param.Contrast, contrast);
	}

	public void setExposure (float value) {
		exposure = value;
		setParam(Param.Exposure, exposure);
	}
