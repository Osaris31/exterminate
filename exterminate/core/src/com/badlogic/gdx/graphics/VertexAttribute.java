...
public final class VertexAttribute {
	...
	public static VertexAttribute NormalPacked () { //OSARIS c'est là que t'as bossé.
		return new VertexAttribute(Usage.NormalPacked, 3, GL20.GL_BYTE, true, ShaderProgram.NORMAL_ATTRIBUTE);
	}

	public static VertexAttribute TexCoordsPacked (int unit) { //OSARIS c'est là que t'as bossé.
