 ...
 * @author mzechner
 * @author Nathan Sweet */
public class FontBatch implements Batch {
	private Mesh mesh;
	...
	public Matrix4 textTransform = new Matrix4().idt();
	 ...
	 * @see SpriteBatch#SpriteBatch(int, ShaderProgram) */
	public FontBatch (int vertexsize) {
	...
	public void draw (Texture texture, float[] spriteVertices, int offset, int count) {
		...
		if(vertexsize==5) {
			...
			int idx = this.idx;
			for(int i=offset;i<count;i+=5) {
				tmpv.set(spriteVertices[i], spriteVertices[i+1], 0);
				tmpv.mul(textTransform);
...
//		idx=0;
		...
		renderCalls++;
		totalRenderCalls++;
		int spritesInBatch = idx / 4/vertexsize;
